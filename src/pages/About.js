...
function About() {
  ...
  <FaQuestionCircle /> Help
      ...
      <Container className="mt-4 text-center" style={{ fontFamily: "'Space Mono', monospace" }}>
        ...
        <p>
          A modern, minimalist note-taking app designed to help you <strong>capture, organize,</strong> and <strong>access</strong> your thoughts effortlessly.
          In today’s fast-paced world, we believe that staying organized should be simple, distraction-free, and efficient.
          Our goal is to provide you with an intuitive space where your ideas can flow freely, without unnecessary clutter or complexity.
        </p>
      </Container>

      <Container className="mt-4 text-start" style={{ fontFamily: "'Space Mono', monospace" }}>
        <h4><MdTaskAlt /> Our Mission</h4>
        <p>
          ...
          That’s why NoteSphere is <strong>lightweight, responsive, and easy to use</strong>, ensuring that you can focus on what truly matters—your thoughts.
        </p>

        <h4><MdOutlinePrivacyTip /> Privacy & Safety</h4>
        <p>
          We understand that your notes may contain personal, sensitive, or important information.
          That’s why we take <strong>security and privacy</strong> seriously. Your data is stored securely using
          <strong> Firebase Firestore</strong>, ensuring that only you have access to your notes. Unlike many other
          platforms, we <strong>do not</strong> sell or share your data with third parties. Your information belongs
        ...
        <p>
          ...
          <a href="https://github.com/ashdejesus" target="_blank" rel="noopener noreferrer"> github.com/ashdejesus</a>
        </p>
      </Container>
    </>
  );
